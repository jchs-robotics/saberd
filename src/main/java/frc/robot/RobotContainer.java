...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // Run shooter
        joystick.rightTrigger(0.3).whileTrue(new ShooterCommand());
        ...
        //manipulatorController.button(3).whileTrue(new InstantCommand(shooterSubsystem::shooterOn)).whileFalse(new InstantCommand(shooterSubsystem::shooterOff));
